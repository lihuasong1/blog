<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\phpstudy\WWW\blog\public/../application/admin\view\index\welcome.html";i:1531917123;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
					...
					<div class="server-panel panel panel-default">
						...
						<div class="panel-body clearfix">
							<div class="col-md-2">
								...
								<span class="info"><?php echo \think\Request::instance()->server('SERVER_SOFTWARE'); ?></span>
							</div>
							<div class="col-md-2">
								<p class="title">服务器IP地址</p>
								<span class="info"><?php echo \think\Request::instance()->server('SERVER_ADDR'); ?></span>
							</div>
							<div class="col-md-2">
								<p class="title">服务器域名</p>
								<span class="info"><?php echo \think\Request::instance()->server('SERVER_NAME'); ?></span>
							</div>
							<!--<div class="col-md-2">-->
							...
							<div class="col-md-2">
								...
								<span class="info"><?php echo date("Y-m-d H:i:s",$time); ?></span>
							</div>
						</div>
					</div>
				</div>
